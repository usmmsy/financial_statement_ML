...
1. Loads REAL quarterly financial data for multiple tickers (YFinanceLoader).
2. Splits data:
...
from balance_sheet_forecaster.data import YFinanceLoader, DummyData
...
# Log config (tickers logged after data load in training function)
...
def train_on_real_data():
    ...
    # ------------------------------------------------------------------
    # 1. Load real fundamentals via yfinance
    # ------------------------------------------------------------------
